...
import com.example.symulacja.rosliny.*;
...
public class World extends JFrame {
    ...
    public World(int width, int height) {
        ...
        button.setBounds(0, height * 20+50, width * 10, 50);
        add(button);
        ...
        button2.setBounds(width * 10, height * 20+100, width * 10, 50);
        add(button2);
        ...
        button3.setBounds(0, height * 20+100, width * 10, 50);
        add(button3);
        ...
        button4.setBounds(width * 10, height * 20+50, width * 10, 50);
        add(button4);
